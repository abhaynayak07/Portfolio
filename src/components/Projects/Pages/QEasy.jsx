                    ...
                    <AnimatePresence mode="wait">
                      ...
                      >
                          ...
                          >
                            <motion.div className="project-overview-container" variants={itemVariants}>
                              <div className="project-overview-set">
                                ...
                                <p>
                                  Q Easy is a digital queue management system that helps people avoid long lines in public spaces like government offices, hospitals, and transport hubs. Users can book tokens remotely, track real-time queue updates, and receive priority support for seniors, pregnant women, and individuals with disabilities, ensuring faster access and a more stress-free service experience. 
                                </p>
                              </div>
                              <div className="project-overview-set">
                                <h3>MY ROLE</h3>
                        ...
                        {activeTab === 1 && (
                          ...
                          >
                            ...
                            <motion.div className="research-grid" variants={itemVariants}>
                              {/* CARD 1 */}
                              <div className="project-overview-set">
                                <h3>QUEUE USER DATA</h3>
                                <div className="bar-group">
                                  {[
                                    { width: "57%", label: "57%", text: "Long Wait Times" },
                                    { width: "33%", label: "33%", text: "Unclear Token Status" },
                                    { width: "19%", label: "19%", text: "Counter Misinformation" }
                                  ].map((bar, idx) => (
                                    <motion.div 
                                      key={idx} 
                                      className="bar"
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="insight-list">
                                  {[
                                    { title: "Irregular Queue Discipline", text: "Physical lines often break due to unclear order." },
                                    { title: "Inconsistent Token Methods", text: "Offices use mixed systems creating user confusion." },
                                    { title: "Staff-Dependent", text: "Users rely completely on verbal announcements." },
                                    { title: "Predictable Crowd Surges", text: "Morning and month-end visits spike heavily." }
                                  ].map((insight, idx) => (
                                    <motion.div 
                                      key={idx} 
                            ...
                            <motion.div className="research-grid" variants={itemVariants}>
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="bar-group">
                                  {[
                                    { width: "49%", label: "49%", text: "Manual Queuing" },
                                    { width: "26%", label: "26%", text: "Staff Enquiries" },
                                    { width: "15%", label: "15%", text: "Public Notice Boards" },
                                    { width: "10%", label: "10%", text: "Security Guard Updates & Other" }
                                  ].map((bar, idx) => (
                                    <motion.div 
                                      key={idx} 
                                      className="bar"
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="bar-group">
                                  {[
                                    { width: "41%", label: "41%", text: "Slow Processing" },
                                    { width: "29%", label: "29%", text: "Queue Mismanagement " }
                                  ].map((bar, idx) => (
                                    <motion.div 
                                      key={idx} 
                                      className="bar"
                          ...
                          >
                            ...
                            <motion.div className="research-grid" variants={itemVariants}>
                              <div className="project-overview-set">
                                <h3>HIGH IMPACT</h3>
                                <p>
                                  Long queues, unclear token updates, and unpredictable wait times cause frustration, delays, and crowd stress. People depend on verbal updates, leading to confusion, pressure, distrust, and around counters. A lack of structured communication makes public services overwhelming and mentally draining especially for senior citizens, women, and physically challenged visitors.
                                </p>
                              </div>
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="insight-list">
                                  {[
                                    { title: "No Clear Wait Times", text: "Users don’t know when their turn comes." },
                                    { title: "Crowded Waiting Areas", text: "People stand for long without movement." },
                                    { title: "Scattered Communication", text: "Updates come late or through unreliable channels." },
                                    { title: "Unfair Queue Jumps", text: "Confusion leads to disputes and frustration." }
                                  ].map((insight, idx) => (
                                    <motion.div
                                      key={idx}
                                      className="insight-card"                 
                            ...
                            <motion.div className="research-grid" variants={itemVariants}>
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="bar-group">
                                  {[
                                    { width: "42%", label: "42%", text: "Time Pressure" },
                                    { width: "28%", label: "28%", text: "Crowd Stress" },
                                    { width: "19%", label: "19%", text: "Uncertainty Worry" },
                                    { width: "11%", label: "11%", text: "Queue Jump Anxiety" }
                                  ].map((bar, idx) => (
                                    <motion.div
                                      key={idx}
                                      className="bar"
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="bar-group">
                                  {[
                                    { width: "42%", label: "42%", text: "Unclear Token Updates" },
                                    { width: "58%", label: "58%", text: "Excessive Wait Times" }
                                  ].map((bar, idx) => (
                                    <motion.div
                                      key={idx}
                                      className="bar"
                        ...
                        {activeTab === 3 && (
                          ...
                          >
                            {[
                              { title: "UX Research & Affinity Diagrams", days: "3 days" },
                              { title: "Lo fi Wireframes", days: "1 day" },
                              { title: "Information Architecture", days: "2 days" },
                              { title: "Wireframes", days: "2 days" },
                              { title: "Design Systems", days: "1 day" },
                              { title: "Interface Design & Prototyping", days: "4 days" }
                            ].map((item, idx) => (
                              <motion.div 
                                key={idx} 
                          ...
                          >
                            ...
                            <motion.div className="row-split" variants={itemVariants}>
                              <div className="project-overview-set big-card">
                                ...
                                <p>
                                  Q-Easy improved transparency through real-time token tracking, reduced crowding with remote queue entries, and eliminated confusion from verbal updates. Users experienced smoother visits, shorter waits, higher efficiency, and increased trust in public service operations, making every interaction faster, predictable, and stress-free.
                                </p>
                              </div>
                              ...
                              <div className="project-overview-set small-card">
                                ...
                                <div className="chart-container">
                                  {[
                                    { before: 28, after: 98, label: "Adoption Rate" },
                                    { before: 14, after: 138, label: "User Satisfaction" },
                                    { before: 37, after: 133, label: "Trust Score" }
                                  ].map((chart, idx) => (
                                    <motion.div
                                      key={idx}
                            ...
                            <motion.div className="row-split" variants={itemVariants}>
                              <div className="project-overview-set small-card">
                                ...
                                <div className="metrics-chart-container">
                                  {[
                                    { before: 79, after: 204, change: "+74%", label: "Token Accuracy" },
                                    { before: 3, after: 180, change: "+61%", label: "Crowd Reduction" },
                                    { before: 25, after: 112, change: "+52%", isFaster: true, label: "Waiting Time" }
                                  ].map((metric, idx) => (
                                    <motion.div
                                      key={idx}
                              ...
                              <div className="project-overview-set big-card qualiotative">
                                ...
                                <div className="insight-list">
                                  {[
                                    { title: "User Confidence", text: "People felt calmer knowing exact wait times." },
                                    { title: "Reduced Queue Stress", text: "Shorter waits eased crowd discomfort." },
                                    { title: "Better Staff Coordination", text: "Staff found it easier tom manage flow." },
                                    { title: "Fair Queue Assurance", text: "Users felt reassured about transparent tokening." }
                                  ].map((insight, idx) => (
                                    <motion.div
                                      key={idx}
                                      className="insight-card"
                          ...
                          >
                            <div className="feature-grid">
                              ...
                              >
                                ...
                                <p>Earlier, citizens struggled with unpredictable queues, unclear token progress, scattered communication, and inconsistent service windows. Managing multiple tasks across different government offices caused stress, delays, and confusion.</p>
                              </motion.div>
        
                              {[
                                { title: "Universal Token System", text: "One token system for all services government offices, hospitals, railways, and more." },
                                { title: "Multi-User Token Booking", text: "Users can take a token for themselves or generate one for family members." },
                                { title: "Accurate Token ETA", text: "Real-time wait-time prediction so users know exactly when their turn arrives." },
                                { title: "Emergency Pause Option", text: "Pause your token for 5 minutes during emergencies without losing your place." },
                                { title: "Service & Direction Details", text: "Clear office descriptions, location directions, service info, and department guidance." },
                                { title: "Appointment Scheduler", text: "Book service dates and time slots to avoid peak hours and long queues." }
                              ].map((feature, idx) => (
                                <motion.div 
                                  key={idx} 
