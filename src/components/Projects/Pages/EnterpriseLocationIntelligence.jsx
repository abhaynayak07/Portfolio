...
import overviewImage4 from "../../../asset/Projects/Page/EnterpriseLocationIntelligence/OverviewImage4.webp";
import overviewImage5 from "../../../asset/Projects/Page/EnterpriseLocationIntelligence/OverviewImage5.webp";
import overviewImage6 from "../../../asset/Projects/Page/EnterpriseLocationIntelligence/OverviewImage6.webp";
import overviewImage7 from "../../../asset/Projects/Page/EnterpriseLocationIntelligence/OverviewImage7.webp";
import overviewImage8 from "../../../asset/Projects/Page/EnterpriseLocationIntelligence/OverviewImage8.webp";
import overviewImage9 from "../../../asset/Projects/Page/EnterpriseLocationIntelligence/OverviewImage9.webp";
import overviewImage10 from "../../../asset/Projects/Page/EnterpriseLocationIntelligence/OverviewImage10.webp";
import overviewImage11 from "../../../asset/Projects/Page/EnterpriseLocationIntelligence/OverviewImage11.webp";
import overviewImage12 from "../../../asset/Projects/Page/EnterpriseLocationIntelligence/OverviewImage12.webp";
import overviewImage13 from "../../../asset/Projects/Page/EnterpriseLocationIntelligence/OverviewImage13.webp";
...
function EnterpriseLocationIntelligence() {
    ...
    >
      ...
      <motion.div className="about-project" variants={itemVariants}>
        ...
        <motion.div className="project-header" variants={itemVariants}>
          <div className="project-header-text-and-icon">
            ...
            <div className="project-header-text">
              <h2>Enterprise Location Intelligence</h2>
                    ...
                    <motion.div className="project-overview-container" variants={itemVariants}>
                      <div className="project-overview-set">
                        <h3>PROJECT OVERVIEW</h3>
                          <p>
                            Smart factories already track every asset, pallet, and AGV in real time. The technology works. The failure happens at the interface level where supervisors must search across maps, tables, and alerts during critical moments. Calm monitoring and crisis situations look identical on screen, with no shift in hierarchy or guidance. Alerts inform but don’t support decisions or next actions.
                          </p>
                      </div>
                      <div className="project-overview-set">
                        <h3>MY ROLE</h3>
                ...
                {activeTab === 1 && (
                  ...
                  >
                    ...
                    <motion.div className="research-grid" variants={itemVariants}>
                      {/* CARD 1 */}
                      <div className="project-overview-set">
													<h3>SUPERVISOR OPERATIONS DATA</h3>
                        <div className="bar-group">
                          {[
															{ width: "52%", label: "52%", text: "Supervisors switch between map, alerts, tables" },
															{ width: "33%", label: "33%", text: "Asset search requires manual filtering" },
															{ width: "15%", label: "15%", text: "Incident closure not system logged" }
                          ].map((bar, idx) => (
                            <motion.div 
                              key={idx} 
                              className="bar"
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="insight-list">
                          {[
														{ title: "Mental Filtering", text: "Users isolate relevant signals themselves" },
														{ title: "Mode Blindness", text: "Normal & crisis states look identical" },
														{ title: "Screen Switching", text: "Map, logs, tables used together" },
														{ title: "Incident Drift", text: "Recovery ends without system closure" }
                          ].map((insight, idx) => (
                            <motion.div 
                              key={idx} 
                    ...
                    <motion.div className="research-grid" variants={itemVariants}>
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="bar-group">
                          {[
														{ width: "44%", label: "44%", text: "Phone calls during asset recovery" },
														{ width: "29%", label: "29%", text: "Peer confirmation before dispatch action" },
														{ width: "18%", label: "18%", text: "Repeated alert interpretation" },
														{ width: "9%", label: "9%", text: "Manual escalation tracking" }
                          ].map((bar, idx) => (
                            <motion.div 
                              key={idx} 
                              className="bar"
                        ...
                        <div className="bar-group">
                          {[
                            { width: "46%", label: "46%", text: "No visibility into real design progress" },
														{ width: "28%", label: "28%", text: "Context spread across multiple screens" }
                          ].map((bar, idx) => (
                            <motion.div 
                              key={idx} 
                              className="bar"
                  ...
                  >
                    ...
                    <motion.div className="research-grid" variants={itemVariants}>
                      <div className="project-overview-set">
                        <h3>HIGH IMPACT</h3>
                        <p>
														System shows all assets equally even during exceptions. Alerts notify missing assets but do not guide recovery steps.
														Supervisors translate location data into action manually.
                        </p>
                      </div>   
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="insight-list">
                          {[
															{ title: "No Mode Shift", text: "Monitoring & recovery look same" },
															{ title: "Context Not Attached", text: "Recovery data across screens" },
															{ title: "No Guided Actions", text: "Next step unclear during search" },
															{ title: "No Closure Flow", text: "Incidents remain mentally closed" }
                          ].map((insight, idx) => (
                            <motion.div
                              key={idx}
                              className="insight-card"                 
                    ...
                    <motion.div className="research-grid" variants={itemVariants}>
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="bar-group">
                          {[
															{ width: "40%", label: "40%", text: "Stress during missing asset recover" },
															{ width: "31%", label: "31%", text: "Fear of wrong dispatch decision" },
															{ width: "18%", label: "18%", text: "Repeated alert checking behaviour" },
															{ width: "11%", label: "11%", text: "Low confidence in resolution tracking" }
                          ].map((bar, idx) => (
                            <motion.div
                              key={idx}
                              className="bar"
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="bar-group">
                          {[
															{ width: "60%", label: "60%", text: "Unclear recovery action path" },
															{ width: "40%", label: "40%", text: "Time lost switching views" }
                          ].map((bar, idx) => (
                            <motion.div
                              key={idx}
                              className="bar"
                  ...
                  >
                    ...
                    <motion.div className="row-split" variants={itemVariants}>
                      <div className="project-overview-set big-card">
                        ...
                        <p>
                            Introduced monitoring vs recovery interface modes, consolidated recovery signals into a single action card, surfaced last location + nearest worker automatically, and created structured incident close-out flow.
                        </p>
                      </div>
                    ...
                    <motion.div className="row-split" variants={itemVariants}>
                      <div className="project-overview-set small-card">
                        ...
                        <div className="metrics-chart-container">
                          {[
                            { before: 165, after: 58, change: "-48%", label: "Recovery Time" },
                            { before: 186, after: 38, change: "-58%", label: "Screen Switching" },
                            { before: 88, after: 128, change: "+20%", isFaster: true, label: "Confidence" }
                          ].map((metric, idx) => (
                            <motion.div
                              key={idx}
                      ...
                      <div className="project-overview-set big-card qualiotative">
                        ...
                        <div className="insight-list">
                          {[
                              { title: "Faster Recovery", text: "Answer surfaced without searching" },
                              { title: "Clear Action Path", text: "One primary step visible" },
                              { title: "Higher Trust", text: "Structured closure flow added" },
                              { title: "Confidence", text: "Higher trust in system" }
                          ].map((insight, idx) => (
                            <motion.div
                              key={idx}
                              className="insight-card"
                    ...
                    <div className="feature-grid">
                      ...
                      >
                        ...
                        <h3>FEATURE HIGHLIGHTS</h3>
                          <p>Solution introduced a recovery mode layer that activates during exceptions. System assembles missing-asset intelligence into one decision card, guides next action, and logs closure automatically.</p>
                      </motion.div>

                      {[
                          { title: "Recovery Mode Layer", text: "Interface shifts during exceptions" },
                          { title: "Decision Support Card", text: "Last seen + nearest worker surfaced" },
                          { title: "Action-First Workflow", text: "Single primary recovery step visible" },
                          { title: "Incident Closure Flow", text: "Auto logging after confirmation" },
                          { title: "Human Status Language", text: "Readable recovery states shown" },
                          { title: "Scalable Factory Ready", text: "Works across large floor maps" }
                      ].map((feature, idx) => (  
                        <motion.div 
                          key={idx} 
        ...
        <div className="project-bento-container with-background">
          <div className="inner-container">
            <h3 className="inner-header">PROBLEM STATEMENT</h3>
            <div className="inner-subcontainer">
              <p className="inner-content">
                Large smart factories generate enormous amounts of real-time location data every asset, every pallet, every AGV is tracked continuously. The technology works. But the people who depend on this data are being failed by the interface that presents it.
              </p>
            </div>
            <div className="inner-subcontainer">
              <p className="inner-content">
                When a critical asset goes missing, the supervisor faces a cruel paradox. The system has all the answers, but the interface forces him to manually hunt for them across multiple screens, tables, and map layers under severe time pressure, in a loud environment, during a moment that demands instant clarity.
              </p>
            </div>
            <div className="inner-subcontainer">
              <p className="inner-content">
                The problem is not a lack of data. The problem is that the interface treats every moment the same calm monitoring and active crisis response look identical on screen. There is no mode shift, no guided action, no decision support. The supervisor is left to do the system's thinking for him.
              </p>
            </div>
            <div className="inner-subcontainer">
              <p className="inner-content" style={{fontWeight:"bold"}}>
                This is a decision support failure disguised as a data problem.
              </p>
            </div>
          </div>
          <div className="inner-container ">
            <img style={{ borderRadius: "0px" }} className="inner-image" src={overviewImage1} />
          </div>
          <div className="inner-container">
            <h3 className="inner-header">KEY USER PAIN POINTS</h3>
            <div className="inner-subcontainer">
              <p className="inner-content">
                The dashboard shows all assets, all zones, all data simultaneously even during a crisis. There is no visual hierarchy that changes when something goes wrong. The supervisor must filter mentally what the system should filter automatically.
              </p>
            </div>
            <div className="inner-subcontainer">
              <p className="inner-content">
                Alerts notify but do not guide. Knowing an asset is missing is step one. Knowing where to look, who to dispatch, and what to do next is step two and the system provides none of them.
              </p>
            </div>
            <div className="inner-subcontainer">
              <p className="inner-content">
                Where is pallet PL-042?" requires switching between the map view, the asset table, the alert log, and sometimes a phone call. Each switch costs time and increases error risk under stress.
              </p>
            </div>
          </div>
          <div className="inner-container">
            <h3 className="inner-header">USER PERSONA</h3>
            <img style={{ borderRadius: "0px" }} className="inner-image" src={overviewImage2} />
          </div>
        </div>

        <div className="project-bento-container with-background">
          <div className="inner-container">
            <h3 className="inner-header">CURRENT STATE JOUNREY MAP</h3>
            <img style={{borderRadius: "0px"}} src={overviewImage3} />
          </div>
          <div className="inner-container">
            <h3 className="inner-header">FUTURE STATE JOUNREY MAP</h3>
        ...
        <div className="project-bento-container with-background">
          <div className="inner-container">
            <h3 className="inner-header">USER FLOW diagram / information architecture</h3>
            <img style={{ borderRadius: "0px" }} src={overviewImage5} />
          </div>
        </div>
        ...
        <div className="project-bento-container with-background">
          <div className="inner-container">
            ...
            <img style={{ borderRadius: "0px" }} src={overviewImage6} />
            <img style={{ borderRadius: "0px" }} src={overviewImage7} />
        ...
        <div className="project-bento-container with-background">
          <div className="inner-container">
            <h3 className="inner-header">INTERFACE DESIGN</h3>
            <img style={{ borderRadius: "0px" }} src={overviewImage10} />
            <img style={{ borderRadius: "0px" }} src={overviewImage11} />
      ...
      <OtherCaseStudies currentProject="enterpriselocationintelligence" />
      </>
  );
}

export default EnterpriseLocationIntelligence;