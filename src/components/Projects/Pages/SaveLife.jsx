                  ...
                  >
                    ...
                    <motion.div className="research-grid" variants={itemVariants}>
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="bar-group">
                          {[
                            { width: "54%", label: "54%", text: "Missed Alerts" },
                            { width: "28%", label: "28%", text: "Eligibility Confusion" },
                            { width: "18%", label: "18%", text: "Low Trust on Outdated Apps" }
                          ].map((bar, idx) => (
                            <motion.div 
                              key={idx} 
                              className="bar"
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="insight-list">
                          {[
                            { title: "Emergency Dependence", text: "People in India rely heavily on manual connections & WhatsApp" },
                            { title: "High Panic", text: "Families under emergency stress, they want quick solutions." },
                            { title: "Lack of Trust", text: "People in India rely heavily on manual connections" },
                            { title: "Fear of Eligibility Confusion", text: "How often they can donate, whether it's safe for them" }
                          ].map((insight, idx) => (
                            <motion.div 
                              key={idx} 
                    ...
                    <motion.div className="research-grid" variants={itemVariants}>
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="bar-group">
                          {[
                            { width: "40%", label: "40%", text: "Missed Alerts" },
                            { width: "30%", label: "30%", text: "Whatsap Groups" },
                            { width: "20%", label: "20%", text: "Local Netwoks & NGO's" },
                            { width: "10%", label: "10%", text: "Social Media Post" }
                          ].map((bar, idx) => (
                            <motion.div 
                              key={idx} 
                              className="bar"
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="bar-group">
                          {[
                            { width: "32%", label: "32%", text: "Tier 2 Cities" },
                            { width: "45%", label: "45%", text: "Tier 3 Cities" }
                          ].map((bar, idx) => (
                            <motion.div 
                              key={idx} 
                              className="bar"
                    ...
                    <motion.div className="row-split" variants={itemVariants}>
                      ...
                      <div className="project-overview-set small-card">
                        ...
                        <div className="chart-container">
                          {[
                            { before: 34, after: 99, label: "Adoption Rate" },
                            { before: 41, after: 128, label: "User Satisfaction" },
                            { before: 63, after: 116, label: "Trust Score" }
                          ].map((chart, idx) => (
                            <motion.div
                              key={idx}
                    ...
                    <motion.div className="row-split" variants={itemVariants}>
                      <div className="project-overview-set small-card">
                        ...
                        <div className="metrics-chart-container">
                          {[
                            { before: 72, after: 170, change: "+37%", label: "Conversion Rate" },
                            { before: 33, after: 217, change: "+65%", label: "Safety Data" },
                            { before: 124, after: 51, change: "+60%", isFaster: true, label: "Waiting Time" }
                          ].map((metric, idx) => (
                            <motion.div
                              key={idx}
                      ...
                      <div className="project-overview-set big-card qualiotative">
                        ...
                        <div className="insight-list">
                          {[
                            { title: "User Confidence", text: "Users reported feeling more in control during emergencies" },
                            { title: "Reduced Panic", text: "Families described the new flow as calmer and reassuring." },
                            { title: "Higher Donor Trust", text: "Donors felt more motivated and safe because profiles are verified." },
                            { title: "Better Medical Coordination", text: "Communication became 'quicker and more consistent'." }
                          ].map((insight, idx) => (
                            <motion.div
                              key={idx}
                              className="insight-card"
                ...
                {activeTab === 5 && (
                  ...
                  >
                    <div className="feature-grid">
                      ...
                      {[
                        { title: "Multilingual Access", text: "Onboarding supports multiple languages so every user understands the app clearly." },
                        { title: "Dual User Flows", text: "Separated donor and recipient journeys to reduce confusion and speed decisions." },
                        { title: "Bold Readability", text: "High-contrast typography improves clarity for seniors and stressed users instantly." },
                        { title: "Clean Interface", text: "A minimal, clutter-free layout helps users act quickly during emergencies." },
                        { title: "One-Tap Emergency", text: "Critical actions simplified into a single tap for faster responses." },
                        { title: "Privacy-Safe ETA", text: "Arrival estimates provided without exposing donor or recipient real-time locations." }
                      ].map((feature, idx) => (
                        <motion.div 
                          key={idx} 
