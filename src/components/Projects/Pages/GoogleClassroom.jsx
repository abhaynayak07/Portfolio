...
import icon from "../../../asset/Projects/Page/Google Classroom/icon.webp";
import banner from "../../../asset/Projects/Page/Google Classroom/banner.webp";
import mobilebanner from "../../../asset/Projects/Page/Google Classroom/mobile banner.webp";
import toolused from "../../../asset/Projects/Page/Google Classroom/tool used.webp";
import overviewimg from "../../../asset/Projects/Page/Google Classroom/overview img.webp";
import secondbanner from "../../../asset/Projects/Page/Google Classroom/second banner.webp";
import mobilesecondbanner from "../../../asset/Projects/Page/Google Classroom/mobile second banner.webp";
import thirdbanner1 from "../../../asset/Projects/Page/Google Classroom/third banner 1.webp";
import thirdbanner2 from "../../../asset/Projects/Page/Google Classroom/third banner 2.webp";
import bento11 from "../../../asset/Projects/Page/Google Classroom/bento 1.1.webp";
import bento12 from "../../../asset/Projects/Page/Google Classroom/bento 1.2.webp";
import bento13 from "../../../asset/Projects/Page/Google Classroom/bento 1.3.webp";
import bento14 from "../../../asset/Projects/Page/Google Classroom/bento 1.4.webp";
import bento15 from "../../../asset/Projects/Page/Google Classroom/bento 1.5.webp";
import bento21 from "../../../asset/Projects/Page/Google Classroom/bento 2.1.webp";
import bento22 from "../../../asset/Projects/Page/Google Classroom/bento 2.2.webp";
import bento23 from "../../../asset/Projects/Page/Google Classroom/bento 2.3.webp";
import bento24 from "../../../asset/Projects/Page/Google Classroom/bento 2.4.webp";
import bento25 from "../../../asset/Projects/Page/Google Classroom/bento 2.5.webp";
                                  ...
                                  >
                                    <motion.div className="project-overview-container" variants={itemVariants}>
                                      <div className="project-overview-set">
                                        ...
                                        <p>
                                          Google Classroom is a free blended learning platform developed by Google for educational institutions that aims to simplify creating, distributing, and grading assignments. The primary purpose of Google Classroom is to streamline the process of sharing files between teachers and students while supporting virtual classrooms, progress tracking, and collaborative digital learning experiences.
                                        </p>
                                      </div>
                                      <div className="project-overview-set">
                                        <h3>MY ROLE</h3>
                                ...
                                {activeTab === 1 && (
                                  ...
                                  >
                                    ...
                                    <motion.div className="research-grid" variants={itemVariants}>
                                      {/* CARD 1 */}
                                      <div className="project-overview-set">
                                        <h3>STUDENT EXPERIENCE DATA</h3>
                                        <div className="bar-group">
                                          {[
                                            { width: "46%", label: "46%", text: "Miss assignment due dates" },
                                            { width: "39%", label: "39%", text: "Confused by multiple subject updates" },
                                            { width: "28%", label: "28%", text: "Skip assignments without reminders" }
                                          ].map((bar, idx) => (
                                            <motion.div 
                                              key={idx} 
                                              className="bar"
                                      ...
                                      <div className="project-overview-set">
                                        ...
                                        <div className="insight-list">
                                          {[
                                            { title: "Last-Minute Submissions", text: "Students submit work close to deadlines." },
                                            { title: "Memory-Based Task Tracking", text: "Assignments remembered mentally, not noted." },
                                            { title: "Multi-Teacher Confusion", text: "Same subject taught by multiple instructors." },
                                            { title: "Teacher-Led Clarifications", text: "Students wait for teachers to initiate doubt solving." }
                                          ].map((insight, idx) => (
                                            <motion.div 
                                              key={idx} 
                                    ...
                                    <motion.div className="research-grid" variants={itemVariants}>
                                      ...
                                      <div className="project-overview-set">
                                        ...
                                        <div className="bar-group">
                                          {[
                                            { width: "51%", label: "51%", text: "Rely on teacher verbal instructions" },
                                            { width: "24%", label: "24%", text: "Depend on parents for tracking tasks" },
                                            { width: "19%", label: "19%", text: "Use external reminder apps" },
                                            { width: "8%", label: "8%", text: "Other" }
                                          ].map((bar, idx) => (
                                            <motion.div 
                                              key={idx} 
                                              className="bar"
                                      ...
                                      <div className="project-overview-set">
                                        ...
                                        <div className="bar-group">
                                          {[
                                            { width: "42%", label: "42%", text: "No assignment reminders" },
                                            { width: "18%", label: "18%", text: "Limited accessibility support" }
                                          ].map((bar, idx) => (
                                            <motion.div 
                                              key={idx} 
                                              className="bar"
                                  ...
                                  >
                                    ...
                                    <motion.div className="research-grid" variants={itemVariants}>
                                      <div className="project-overview-set">
                                        <h3>HIGH IMPACT</h3>
                                        <p>
                                          Missed assignment deadlines, unclear communication between teachers and students, and poor virtual engagement reduce learning seriousness. Students struggle to remember tasks, track tests, and clarify doubts during online classes, causing low accountability and inconsistent academic performance across grade levels.
                                        </p>
                                      </div>
                                      ...
                                      <div className="project-overview-set">
                                        ...
                                        <div className="insight-list">
                                          {[
                                            { title: "No Due Date Visibility", text: "Assignments lack clear deadline indicators" },
                                            { title: "Doubt Clarification Gap", text: "No direct student–teacher interaction" },
                                            { title: "Unstructured Subject Flow", text: "Multiple teachers for same subject create confusion" },
                                            { title: "Accessibility Limitations", text: "No voice support for disabled users" }
                                          ].map((insight, idx) => (
                                            <motion.div
                                              key={idx}
                                              className="insight-card"                 
                                    ...
                                    <motion.div className="research-grid" variants={itemVariants}>
                                      ...
                                      <div className="project-overview-set">
                                        ...
                                        <div className="bar-group">
                                          {[
                                            { width: "41%", label: "41%", text: "Academic Anxiety" },
                                            { width: "27%", label: "27%", text: "Missed Deadline Stress" },
                                            { width: "19%", label: "19%", text: "Confusion Over Subjects" },
                                            { width: "13%", label: "13%", text: "Low Motivation" }
                                          ].map((bar, idx) => (
                                            <motion.div
                                              key={idx}
                                              className="bar"
                                      ...
                                      {/* CARD 4 */}
                                      <div className="project-overview-set">
                                        <h3>QUEUE PAIN POINTS IN INDIA</h3>
                
                                        <div className="bar-group">
                                          {[
                                            { width: "56%", label: "56%", text: "Forget assignment dates" },
                                            { width: "38%", label: "38%", text: "Poor virtual engagement" }
                                          ].map((bar, idx) => (
                                            <motion.div
                                              key={idx}
                                              className="bar"
                                  ...
                                  >
                                    ...
                                    <motion.div className="row-split" variants={itemVariants}>
                                      <div className="project-overview-set big-card">
                                        ...
                                        <p>
                                          The redesigned Classroom experience improved assignment visibility, strengthened student–teacher interaction, and introduced structured reminders. Students became more accountable, parents gained clearer progress tracking, and virtual learning became more interactive, inclusive, and deadline-driven across classrooms.
                                        </p>
                                      </div>
                                      ...
                                      <div className="project-overview-set small-card">
                                        ...
                                        <div className="chart-container">
                                          {[
                                            { before: 69, after: 129, label: "Adoption Rate" },
                                            { before: 40, after: 130, label: "User Satisfaction" },
                                            { before: 54, after: 112, label: "Trust Score" }
                                          ].map((chart, idx) => (
                                            <motion.div
                                              key={idx}
                                    ...
                                    <motion.div className="row-split" variants={itemVariants}>
                                      <div className="project-overview-set small-card">
                                        ...
                                        <div className="metrics-chart-container">
                                          {[
                                            { before: 33, after: 188, change: "+62%", label: "Track Accuracy" },
                                            { before: 84, after: 144, change: "+48%", label: "On Time Submission" },
                                            { before: 68, after: 173, change: "+53%", isFaster: true, label: "Student Engaging" }
                                          ].map((metric, idx) => (
                                            <motion.div
                                              key={idx}
                                      ...
                                      <div className="project-overview-set big-card qualiotative">
                                        ...
                                        <div className="insight-list">
                                          {[
                                            { title: "Better Student Discipline", text: "Clear reminders improve submission behavior" },
                                            { title: "Improved Parent Visibility", text: "Scores and progress easily trackable" },
                                            { title: "Higher Classroom Interaction", text: "Chat-based doubt clarification boosts learning" },
                                            { title: "Inclusive Learning Experience", text: "Voice assistant supports accessibility" }
                                          ].map((insight, idx) => (
                                            <motion.div
                                              key={idx}
                                              className="insight-card"
                                  ...
                                  >
                                    <div className="feature-grid">
                                      ...
                                      >
                                        ...
                                        <p>Earlier, students missed deadlines, struggled with unclear communication, and lacked engagement in virtual classrooms. The redesign introduces clarity, accountability, accessibility, and stronger interaction for effective online learning.</p>
                                      </motion.div>
                
                                      {[
                                        { title: "Smart Assignment Reminders", text: "Automated alerts for assignments, exams, and submission deadlines." },
                                        { title: "Student–Teacher Chat", text: "In-app chat for instant doubt clarification during virtual classes." },
                                        { title: "Structured Subject Dashboard", text: "Clear separation of subjects, teachers, tests, and materials." },
                                        { title: "Assignment Progress Tracker", text: "View submitted, pending, and past assignments effortlessly." },
                                        { title: "Parent Progress View", text: "Parents track test scores, assignments, and learning progress." },
                                        { title: "Voice Assistant Access", text: "Voice-enabled search and navigation for accessibility support." }
                                      ].map((feature, idx) => (
                                        <motion.div 
                                          key={idx} 
