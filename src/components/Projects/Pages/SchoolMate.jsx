...
import icon from "../../../asset/Projects/Page/School Mate/icon.webp";
import banner from "../../../asset/Projects/Page/School Mate/banner.webp";
import mobilebanner from "../../../asset/Projects/Page/School Mate/mobile banner.webp";
import toolused from "../../../asset/Projects/Page/School Mate/tool used.webp";
import overviewimg from "../../../asset/Projects/Page/School Mate/overview img.webp";
import bento11 from "../../../asset/Projects/Page/School Mate/bento 1.1.webp";
import bento12 from "../../../asset/Projects/Page/School Mate/bento 1.2.webp";
import bento13 from "../../../asset/Projects/Page/School Mate/bento 1.3.webp";
import bento14 from "../../../asset/Projects/Page/School Mate/bento 1.4.webp";
import bento15 from "../../../asset/Projects/Page/School Mate/bento 1.5.webp";
import bento16 from "../../../asset/Projects/Page/School Mate/bento 1.6.webp";
import bento21 from "../../../asset/Projects/Page/School Mate/bento 2.1.webp";
import bento22 from "../../../asset/Projects/Page/School Mate/bento 2.2.webp";
import bento23 from "../../../asset/Projects/Page/School Mate/bento 2.3.webp";
import bento24 from "../../../asset/Projects/Page/School Mate/bento 2.4.webp";
import bento25 from "../../../asset/Projects/Page/School Mate/bento 2.5.webp";
import bento26 from "../../../asset/Projects/Page/School Mate/bento 2.6.webp";
      ...
      <motion.div className="about-project" variants={itemVariants}>
        <div className="project-header">
          ...
          <div className="project-header-banner">
            ...
            <img src={mobilebanner} className="mobile" alt="School Mate Banner"/>
          </div>
        </div>
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      >
                          ...
                          >
                            <motion.div className="project-overview-container" variants={itemVariants}>
                              <div className="project-overview-set">
                                ...
                                <p>
                                  The School Bus Tracker App is a real-time safety solution designed for parents to stay informed and reassured about their child’s journey to and from school. It helps parents track boarding and drop-off activity through smart ID scans, provides timely notifications, supports multi-child management, and is available in multiple Indian languages to ensure inclusivity across regions. 
                                </p>
                              </div>
                              <div className="project-overview-set">
                                <h3>MY ROLE</h3>
                          ...
                          >
                            ...
                            <motion.div className="research-grid" variants={itemVariants}>
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="bar-group">
                                  {[
                                    { width: "52%", label: "52%", text: "Missed Bus Timing" },
                                    { width: "31%", label: "31%", text: "Route Uncertainty" },
                                    { width: "17%", label: "17%", text: "Driver Communication Delays & Other" }
                                  ].map((bar, idx) => (
                                    <motion.div 
                                      key={idx} 
                                      className="bar"
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="insight-list">
                                  {[
                                    { title: "High Anxiety", text: "Parents feel stressed when they can’t track the child’s real location." },
                                    { title: "Safety Dependency", text: "Parents depend heavily on schools or drivers for updates." },
                                    { title: "Misinformation Loops", text: "Parents often trust rumors or WhatsApp messages." },
                                    { title: "Timing Sensitivity", text: "Even 5–10 minutes delay causes panic for working parents." }
                                  ].map((insight, idx) => (
                                    <motion.div 
                                      key={idx} 
                            ...
                            <motion.div className="research-grid" variants={itemVariants}>
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="bar-group">
                                  {[
                                    { width: "45%", label: "45%", text: "Manual Calls" },
                                    { width: "38%", label: "38%", text: "Whatsap Groups" },
                                    { width: "17%", label: "17%", text: "Other Parents Updates" },
                                    { width: "10%", label: "10%", text: "School Notice / Calls" }
                                  ].map((bar, idx) => (
                                    <motion.div 
                                      key={idx} 
                                      className="bar"
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="bar-group">
                                  {[
                                    { width: "38%", label: "38%", text: "Tier 1 Cities" },
                                    { width: "27%", label: "27%", text: "Tier 2 Cities" }
                                  ].map((bar, idx) => (
                                    <motion.div 
                                      key={idx} 
                                      className="bar"
                          ...
                          >
                            ...
                            <motion.div className="research-grid" variants={itemVariants}>
                              <div className="project-overview-set">
                                <h3>HIGH IMPACT</h3>
                                <p>
                                  When school transport fails - late buses, unclear routes, or uncertain arrival times parents lose peace of mind, students feel stressed, and staff struggle to coordinate. These issues disrupt schedules, raise safety concerns, and force families into constant calls or guesswork. creating long-term anxiety and distrust.
                                </p>
                              </div>
        
                              {/* CARD 2 */}
                              <div className="project-overview-set">
                                <h3>WHAT'S BROKEN IN THE CERTAIN SYSTEM</h3>
        
                                <div className="insight-list">
                                  {[
                                    { title: "Uncertain Arrival Times", text: "Parents don’t know exact arrival or delay status." },
                                    { title: "Poor Communication Loops", text: "Updates come late, scattered, and inconsistent across channels." },
                                    { title: "Safety Anxiety", text: "No visibility creates fear about route or delays." },
                                    { title: "Multi-Child Chaos", text: "Managing different pickups becomes confusing and stressful." }
                                  ].map((insight, idx) => (
                                    <motion.div
                                      key={idx}
                                      className="insight-card"
                            ...
                            <motion.div className="research-grid" variants={itemVariants}>
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="bar-group">
                                  {[
                                    { width: "38%", label: "38%", text: "Time Pressure" },
                                    { width: "26%", label: "26%", text: "Safety Worry" },
                                    { width: "22%", label: "22%", text: "Uncertainty Stress" },
                                    { width: "14%", label: "14%", text: "Dependency Delays" }
                                  ].map((bar, idx) => (
                                    <motion.div
                                      key={idx}
                                      className="bar"
                              ...
                              {/* CARD 4 */}
                              <div className="project-overview-set">
                                <h3>ROUTE RISK IN INDIA</h3>
        
                                <div className="bar-group">
                                  {[
                                    { width: "35%", label: "35%", text: "Heavy Traffic Delays" },
                                    { width: "50%", label: "50%", text: "Frequent Route Diversions & Breakdowns" }
                                  ].map((bar, idx) => (
                                    <motion.div
                                      key={idx}
                                      className="bar"
                        ...
                        {activeTab === 3 && (
                          ...
                          >
                            {[
                              { title: "UX Research & Lo-Fi Wireframes", days: "6 days" },
                              { title: "Affinity Diagrams", days: "2 days"},
                              { title: "Journey Mapping & Information Architecture", days: "3 days" },
                              { title: "Wireframes", days: "4 days" },
                              { title: "Design Systems ", days: "1 day" },
                              { title: "Interface Design & Prototyping", days: "5 days" }
                            ].map((item, idx) => (
                              <motion.div 
                                key={idx} 
                          ...
                          >
                            ...
                            <motion.div className="row-split" variants={itemVariants}>
                              <div className="project-overview-set big-card">
                                ...
                                <p>
                                  The redesigned school bus tracking experience improved real-time visibility for parents, reduced confusion caused by uncertain bus timings, and significantly lowered manual coordination between parents, drivers, and school staff. The streamlined flows increased trust, enhanced safety perception, and made daily school commutes more predictable and stress-free for families.
                                </p>
                              </div>
                              ...
                              <div className="project-overview-set small-card">
                                ...
                                <div className="chart-container">
                                  {[
                                    { before: 9, after: 126, label: "Adoption Rate" },
                                    { before: 21, after: 138, label: "User Satisfaction" },
                                    { before: 56, after: 111, label: "Trust Score" }
                                  ].map((chart, idx) => (
                                    <motion.div
                                      key={idx}
                            ...
                            <motion.div className="row-split" variants={itemVariants}>
                              <div className="project-overview-set small-card">
                                ...
                                <div className="metrics-chart-container">
                                  {[
                                    { before: 41, after: 207, change: "+72%", label: "Tracking Accuracy" },
                                    { before: 21, after: 180, change: "+64%", label: "Comm Safety" },
                                    { before: 63, after: 199, change: "+58%", isFaster: true, label: "Waiting Time" }
                                  ].map((metric, idx) => (
                                    <motion.div
                                      key={idx}
                              ...
                              <div className="project-overview-set big-card qualiotative">
                                ...
                                <div className="insight-list">
                                  {[
                                    { title: "Parent Confidence", text: "Parents reported feeling calmer due to real-time visibility." },
                                    { title: "Reduced Evening Stress", text: "Families experienced smoother routines with precise ETAs." },
                                    { title: "Better Driver Coordination", text: "Drivers found communication simpler and more consistent." },
                                    { title: "Improved Safety Assurance", text: "Parents felt reassured due to consistent location updates." }
                                  ].map((insight, idx) => (
                                    <motion.div
                                      key={idx}
                                      className="insight-card"
                          ...
                          >
                            <div className="feature-grid">
                              ...
                              >
                                ...
                                <p>Earlier, parents faced unpredictable bus timings, no real-time updates, scattered communication, and managing multiple children became stressful. Uncertain delays and unclear status made daily school commutes confusing, unreliable, and anxiety-filled for families.</p>
                              </motion.div>
        
                              {[
                                { title: "Live Location Tracking", text: "Real-time bus location so parents always know the exact route." },
                                { title: "Multi-Child Switching", text: "Quickly switch between multiple children to view individual bus status." },
                                { title: "Smart ETA Prediction", text: "Accurate arrival predictions reduce waiting time and daily uncertainty." },
                                { title: "Leave & Half-Day Updates", text: "Parents can mark full-day or half-day leave so drivers skip the stop, reducing confusion." },
                                { title: "Multilingual Support", text: "Supports major Indian languages for clearer understanding across parents." },
                                { title: "Simplified Navigation", text: "Clean layout with essential actions instantly accessible during rush hours." }
                              ].map((feature, idx) => (
                                <motion.div 
                                  key={idx} 
