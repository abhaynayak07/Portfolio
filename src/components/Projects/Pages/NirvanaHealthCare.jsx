...
import icon from "../../../asset/Projects/Page/NirvanaHealthCare/NirvanaLogo.webp";
import banner from "../../../asset/Projects/Page/NirvanaHealthCare/NirvanaBanner.webp";
import Bento1 from "../../../asset/Projects/Page/NirvanaHealthCare/Bento1.webp";
import Bento2 from "../../../asset/Projects/Page/NirvanaHealthCare/Bento2.webp";
import Bento3 from "../../../asset/Projects/Page/NirvanaHealthCare/Bento3.webp";
import Bento4 from "../../../asset/Projects/Page/NirvanaHealthCare/Bento4.webp";
import Bento5 from "../../../asset/Projects/Page/NirvanaHealthCare/Bento5.webp";
import Bento6 from "../../../asset/Projects/Page/NirvanaHealthCare/Bento6.webp";
import Bento7 from "../../../asset/Projects/Page/NirvanaHealthCare/Bento7.webp";
          ...
          <div className="project-header-text-and-icon">
            <div className="project-header-icon">
              <img
                src={icon}
                style={{
                  boxShadow: "0px 2px 45px 0px #3F51BF",
                }}
                alt="Nirvana Icon"
              />
            </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                  ...
                  >
                    <motion.div className="project-overview-container" variants={itemVariants}>
                      <div className="project-overview-set">
                        ...
                        <p>
                          Nirvaana Health Cares Dashboard is a centralized hospital operations platform designed to help hospital managers monitor OPD, IPD, Emergency, beds, staff, and reports in real time, across departments, enabling faster decisions, proactive planning, risk reduction, workload balance, and operational transparency during high-pressure hospital environments daily. 
                        </p>
                      </div>
                      <div className="project-overview-set">
                        <h3>MY ROLE</h3>
                ...
                {activeTab === 1 && (
                  ...
                  >
                    ...
                    <motion.div className="research-grid" variants={itemVariants}>
                      {/* CARD 1 */}
                      <div className="project-overview-set">
                        <h3>DASHBOARD EXPERIENCE DATA</h3>
                        <div className="bar-group">
                          {[
                            { width: "51%", label: "51%", text: "Hard to identify critical issues quickly" },
                            { width: "28%", label: "28%", text: "Data spread across multiple systems" },
                            { width: "21%", label: "21%", text: "Overloaded screens, unclear priorities" }
                          ].map((bar, idx) => (
                            <motion.div 
                              key={idx} 
                              className="bar"
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="insight-list">
                          {[
                            { title: "Frequent Checks", text: "Frequent dashboard checks during peak hours" },
                            { title: "Emergency Prioritization", text: "Priority given to emergency-related metrics" },
                            { title: "Manual Confirmation", text: "Manual confirmation before major decisions" },
                            { title: "Reactive Reporting Culture", text: "Reports reviewed post-incident, not before" }
                          ].map((insight, idx) => (
                            <motion.div 
                              key={idx} 
                    ...
                    <motion.div className="research-grid" variants={itemVariants}>
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="bar-group">
                          {[
                            { width: "38%", label: "38%", text: "Verbal updates from staff" },
                            { width: "26%", label: "26%", text: "WhatsApp / phone calls" },
                            { width: "18%", label: "18%", text: "Use external reminder apps" },
                            { width: "18%", label: "18%", text: "End-of-day system reports & Other" }
                          ].map((bar, idx) => (
                            <motion.div 
                              key={idx} 
                              className="bar"
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="bar-group">
                          {[
                            { width: "48%", label: "48%", text: "Delayed bed availability visibility" },
                            { width: "22%", label: "22%", text: "No early warning for overload" }
                          ].map((bar, idx) => (
                            <motion.div 
                              key={idx} 
                              className="bar"
                  ...
                  >
                    ...
                    <motion.div className="research-grid" variants={itemVariants}>
                      <div className="project-overview-set">
                        <h3>HIGH IMPACT</h3>
                        <p>
                          Hospital managers lacked a single source of truth for real-time operations, leading to delayed decisions, resource misallocation, and increased stress during emergencies and peak patient inflow periods, often relying on verbal updates and fragmented systems to fill information gaps, especially during night shifts and high-dependency care situations without visibility.
                        </p>
                      </div>
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="insight-list">
                          {[
                            { title: "No Real Time Data", text: "No real-time bed availability visibility" },
                            { title: "Data Not Connected", text: "OPD and IPD data not connected in the most screens" },
                            { title: "Late Triggers", text: "Emergency alerts triggered too late" },
                            { title: "Late Flagging", text: "Staff overwork not flagged early in the current system" }
                          ].map((insight, idx) => (
                            <motion.div
                              key={idx}
                              className="insight-card"                 
                    ...
                    <motion.div className="research-grid" variants={itemVariants}>
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="bar-group">
                          {[
                            { width: "44%", label: "44%", text: "Stress During Peak Load" },
                            { width: "29%", label: "29%", text: "Fear of missing critical issues" },
                            { width: "18%", label: "18%", text: "Frustration with manual follow-ups" },
                            { width: "9%", label: "9%", text: "Low Confidence in Data" }
                          ].map((bar, idx) => (
                            <motion.div
                              key={idx}
                              className="bar"
                      ...
                      <div className="project-overview-set">
                        ...
                        <div className="bar-group">
                          {[
                            { width: "58%", label: "58%", text: "Bed shortages discovered too late" },
                            { width: "42%", label: "42%", text: "Emergency overload mismanagement" }
                          ].map((bar, idx) => (
                            <motion.div
                              key={idx}
                              className="bar"
                ...
                {activeTab === 3 && (
                  ...
                  >
                    {[
                      { title: "UX Research & LoFi Wireframes", days: "4 days" },
                      { title: "Affinity Mapping", days: "1 day" },
                      { title: "Information Architecture", days: "1 day" },
                      { title: "Wireframes", days: "3 days" },
                      { title: "Design Systems & Components", days: "2 days" },
                      { title: "Interface Design & Prototyping", days: "9 days" }
                    ].map((item, idx) => (
                      <motion.div 
                        key={idx} 
                  ...
                  >
                    ...
                    <motion.div className="row-split" variants={itemVariants}>
                      <div className="project-overview-set big-card">
                        ...
                        <p>
                          After implementing the dashboard, hospital teams gained real-time operational clarity, reduced dependency on manual updates, and could proactively manage beds, staff, and emergencies instead of reacting after escalation, improving accountability, response times, cross-team coordination, and daily operational confidence across departments.
                        </p>
                      </div>
                    ...
                    <motion.div className="row-split" variants={itemVariants}>
                      <div className="project-overview-set small-card">
                        ...
                        <div className="metrics-chart-container">
                          {[
                            { before: 48, after: 148, change: "+57%", label: "Track Accuracy" },
                            { before: 55, after: 190, change: "+68%", label: "Emergency Visibility" },
                            { before: 49, after: 118, change: "+48%", isFaster: true, label: "Decision Making" }
                          ].map((metric, idx) => (
                            <motion.div
                              key={idx}
                      ...
                      <div className="project-overview-set big-card qualiotative">
                        ...
                        <div className="insight-list">
                          {[
                            { title: "Faster Decisions", text: "Faster decisions, reduced stress during critical hospital operations" },
                            { title: "Improved Parent Visibility", text: "Better preparedness during peak hours" },
                            { title: "Reduced Dependency", text: "Reduced dependency on phone calls" },
                            { title: "Confidence", text: "Higher confidence in daily operations" }
                          ].map((insight, idx) => (
                            <motion.div
                              key={idx}
                              className="insight-card"
                  ...
                  >
                    <div className="feature-grid">
                      ...
                      >
                        ...
                        <p>Previously, hospital teams relied on fragmented systems, verbal updates, and delayed reports, making it difficult to anticipate operational risks. The new dashboard unified critical data streams into a single, real-time view, enabling proactive decision-making and smoother hospital operations.</p>
                      </motion.div>

                      {[
                        { title: "Unified Operations View", text: "OPD, IPD, and emergency metrics unified into one operational dashboard" },
                        { title: "Real-Time Bed Utilization", text: "Live ward occupancy tracking prevents last-minute capacity and admission issues" },
                        { title: "Emergency Readiness Indicators", text: "Critical alerts highlight risks before emergencies escalate into operational failures" },
                        { title: "Staff Availability Tracking", text: "Live duty status reduces burnout and improves workforce allocation decisions" },
                        { title: "Actionable Reports & Insights", text: "Structured reports enable faster planning instead of reactive problem-solving decisions" },
                        { title: "Time-Based Trend Analysis", text: "Peak load patterns reveal demand surges across departments and shifts" }
                      ].map((feature, idx) => (
                        <motion.div 
                          key={idx} 
