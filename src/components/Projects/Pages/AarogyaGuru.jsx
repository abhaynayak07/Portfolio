                    ...
                    <AnimatePresence mode="wait">
                      ...
                      >
                          ...
                          >
                            <motion.div className="project-overview-container" variants={itemVariants}>
                              <div className="project-overview-set">
                                ...
                                <p>
                                  Aarogya Guru is a health appointment app that simplifies scheduling with healthcare professionals. It eliminates the hassle of managing appointments, ensuring a seamless experience. Whether for a routine check-up or a specific concern, the user-friendly interface offers convenience. The app empowers individuals to take control of their health with ease.
                                </p>
                              </div>
                              <div className="project-overview-set">
                                <h3>MY ROLE</h3>
                        ...
                        {activeTab === 1 && (
                          ...
                          >
                            ...
                            <motion.div className="research-grid" variants={itemVariants}>
                              {/* CARD 1 */}
                              <div className="project-overview-set">
                                <h3>PATIENT EXPERIANCE DATA</h3>
                                <div className="bar-group">
                                  {[
                                    { width: "64%", label: "64%", text: "Long waiting hours in hospitals" },
                                    { width: "41%", label: "41%", text: "Appointment uncertainty" },
                                    { width: "22%", label: "22%", text: "Misplaced medical records" }
                                  ].map((bar, idx) => (
                                    <motion.div 
                                      key={idx} 
                                      className="bar"
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="insight-list">
                                  {[
                                    { title: "Unplanned Doctor Visits", text: "Irregular clinic timings lead to frequent walk-ins." },
                                    { title: "Report Mismanagement", text: "People misplace prescriptions and struggle to track past treatments." },
                                    { title: "Dependence on Phone Booking", text: "Users rely heavily on calling hospitals for availability, timings." },
                                    { title: "Peak-Hour Rush Patterns", text: "Evenings, weekends visits spike heavily across clinics." }
                                  ].map((insight, idx) => (
                                    <motion.div 
                                      key={idx} 
                            ...
                            <motion.div className="research-grid" variants={itemVariants}>
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="bar-group">
                                  {[
                                    { width: "52%", label: "52%", text: "Manual registration queues" },
                                    { width: "37%", label: "37%", text: "Phone-based appointment" },
                                    { width: "18%", label: "18%", text: "No tracking for test report status" },
                                    { width: "9%", label: "9%", text: "Other" }
                                  ].map((bar, idx) => (
                                    <motion.div 
                                      key={idx} 
                                      className="bar"
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="bar-group">
                                  {[
                                    { width: "49%", label: "49%", text: "Lack of digital appointment systems" },
                                    { width: "33%", label: "33%", text: "No record history accessible to users" }
                                  ].map((bar, idx) => (
                                    <motion.div 
                                      key={idx} 
                                      className="bar"
                          ...
                          >
                            ...
                            <motion.div className="research-grid" variants={itemVariants}>
                              <div className="project-overview-set">
                                <h3>HIGH IMPACT</h3>
                                <p>
                                  Long hospital queues, no time-slot assurance, and misplaced medical reports create stress for patients and families. Manual bookings, unnecessary revisits, and inconsistent information waste hours, impacting working professionals, elderly patients, pregnant women, disabled kids,  and anyone relying on timely care. 
                                </p>
                              </div>
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="insight-list">
                                  {[
                                    { title: "No Time-Slot Appointments", text: "Patients must wait hours without guaranteed doctor timing." },
                                    { title: "Manual Phone Bookings", text: "Staff overloaded answering calls for slot confirmations." },
                                    { title: "Lost Medical Records", text: "Prescriptions, test reports, and history rarely stored safely." },
                                    { title: "Overcrowded Waiting Rooms", text: "Everyone arrives early due to unclear wait expectations." }
                                  ].map((insight, idx) => (
                                    <motion.div
                                      key={idx}
                                      className="insight-card"                 
                            ...
                            <motion.div className="research-grid" variants={itemVariants}>
                              ...
                              <div className="project-overview-set">
                                ...
                                <div className="bar-group">
                                  {[
                                    { width: "39%", label: "39%", text: "Crowd Stress" },
                                    { width: "31%", label: "31%", text: "Anxiety" },
                                    { width: "20%", label: "20%", text: "Worry of Loosing Past Records" },
                                    { width: "10%", label: "10%", text: "Pressure to take Leave" }
                                  ].map((bar, idx) => (
                                    <motion.div
                                      key={idx}
                                      className="bar"
                              ...
                              {/* CARD 4 */}
                              <div className="project-overview-set">
                                <h3>HEALTHCARE PAIN POINTS IN INDIA</h3>
        
                                <div className="bar-group">
                                  {[
                                    { width: "46%", label: "46%", text: "Uncertain doctor availability" },
                                    { width: "54%", label: "54%", text: "Excessive Waiting Hours" }
                                  ].map((bar, idx) => (
                                    <motion.div
                                      key={idx}
                                      className="bar"
                        ...
                        {activeTab === 3 && (
                          ...
                          >
                            {[
                              { title: "UX Research & Affinity Diagrams", days: "7 days" },
                              { title: "Lo fi Wireframes", days: "3 days" },
                              { title: "Information Architecture", days: "1 day" },
                              { title: "Wireframes", days: "7 days" },
                              { title: "Design Systems", days: "1 day" },
                              { title: "Interface Design & Prototyping", days: "21 days" }
                            ].map((item, idx) => (
                              <motion.div 
                                key={idx} 
                          ...
                          >
                            ...
                            <motion.div className="row-split" variants={itemVariants}>
                              <div className="project-overview-set big-card">
                                ...
                                <p>
                                  Aarogya Guru transformed hospital visits by offering scheduled, trackable, and predictable appointments. Patients reduced waiting times, avoided unnecessary revisits, and accessed medical history instantly. Clinics observed smoother workflows, fewer phone-booking interruptions, and more organized patient inflow making healthcare more convenient across India.
                                </p>
                              </div>
                              ...
                              <div className="project-overview-set small-card">
                                ...
                                <div className="chart-container">
                                  {[
                                    { before: 43, after: 113, label: "Adoption Rate" },
                                    { before: 6, after: 138, label: "User Satisfaction" },
                                    { before: 60, after: 133, label: "Trust Score" }
                                  ].map((chart, idx) => (
                                    <motion.div
                                      key={idx}
                            ...
                            <motion.div className="row-split" variants={itemVariants}>
                              <div className="project-overview-set small-card">
                                ...
                                <div className="metrics-chart-container">
                                  {[
                                    { before: 42, after: 194, change: "+63%", label: "Queue Time" },
                                    { before: 28, after: 209, change: "+78%", label: "Record Accesible" },
                                    { before: 54, after: 162, change: "+57%", isFaster: true, label: "Staff Load" }
                                  ].map((metric, idx) => (
                                    <motion.div
                                      key={idx}
                              ...
                              <div className="project-overview-set big-card qualiotative">
                                ...
                                <div className="insight-list">
                                  {[
                                    { title: "Patient Confidence", text: "Users feel secure with stored records" },
                                    { title: "Reduced Queue Stress", text: "Predictable slots ease anxiety" },
                                    { title: "Better Clinic Flow", text: "Staff manage fewer walk-ins with smoother, predictable scheduling." },
                                    { title: "Care Continuity", text: "Communication became 'quicker and more consistent'." }
                                  ].map((insight, idx) => (
                                    <motion.div
                                      key={idx}
                                      className="insight-card"
                          ...
                          >
                            <div className="feature-grid">
                              ...
                              >
                                ...
                                <p>Earlier, patients struggled with long hospital queues, unclear doctor availability, misplaced medical records, and inconsistent appointment systems. Managing multiple health concerns across clinics caused stress, wasted hours, and constant revisits.</p>
                              </motion.div>
        
                              {[
                                { title: "Nearby Doctor Discovery", text: "Find trusted doctors near your location across clinics and hospitals instantly." },
                                { title: "Specialist Selection Made Easy", text: "Browse surgeons, cardiologists, neurologists, and other specialists without confusion." },
                                { title: "Digital Medical Records Vault", text: "Store prescriptions, blood tests, reports, and all past medical documents securely." },
                                { title: "Flexible Appointment Booking", text: "Choose your preferred date and time to avoid long waiting hours." },
                                { title: "Vaccination & Health Reminders", text: "Get notified about essential vaccines like COVID, TT, and flu at nearby centers." },
                                { title: "Test Reports Access Anytime", text: "View your lab results and doctor-uploaded reports whenever needed with one tap." }
                              ].map((feature, idx) => (
                                <motion.div 
                                  key={idx} 
